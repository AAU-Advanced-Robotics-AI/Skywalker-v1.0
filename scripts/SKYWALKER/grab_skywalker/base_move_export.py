...
- base_pos_w (3): base position in world frame
- base_quat_w (4): base orientation quaternion in world frame
    ...
    def _build_skrl_policy(self, state_dict):
        ...
        for i, layer_idx in enumerate(layer_indices):
            ...
            if 'weight' in layer_params:
                ...
                # Add ReLU between layers (but not after the last net_container layer)
        ...
        if 'policy_layer.weight' in state_dict:
            ...
            # Add ReLU before final layer if we have net_container layers
            if layers:
                layers.append(torch.nn.ReLU())
