...
class SurfaceGripperActionTerm(ActionTerm):
    ...
    def __init__(self, cfg, env: ManagerBasedEnv):
        ...
        #     sgp.offset = physics.Transform()
        #     sgp.offset.p.x = 0
        #     sgp.offset.p.z = -0.1001
        #     sgp.offset.r = [0, 0.7071, 0, 0.7071] 
        #     sgp.forceLimit = 50
        #     sgp.torqueLimit = 50
        #     sgp.stiffness = 100
        #     sgp.damping = 100
        #     sgp.disableGravity = False # Rotate to point gripper in Z direction
        #     gripper.initialize(sgp)
        #     self._surface_grippers.append(gripper)
        #     self._gripper_prim_paths.append(prim_path)
    ...
    def apply_actions(self):
        ...
        for i in to_close:
            ...
            if not gripper.is_closed():
                ...
                if result:
                    print("gripper closed correctly")
            gripper.update()
        ...
        for i in to_open:
            ...
            result = gripper.open()
            if result:
                print("gripper opened correctly")
            gripper.update()
