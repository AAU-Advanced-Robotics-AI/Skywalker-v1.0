...
class SkywalkerSceneCfg(InteractiveSceneCfg):
    ...
    #skywalker : ArticulationCfg = MISSING
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        pose_command = ObsTerm(func=mdp.generated_commands, params={"command_name": "ee_pose"}) # STILL TO UNDERSTAND
...
class RewardsCfg:
    ...
    end_effector_position_tracking = RewTerm(
        ...
        weight=-0.2,
        params={"asset_cfg": SceneEntityCfg("robot", body_names="link_eef"), "command_name": "ee_pose"},
    )
    # end_effector_position_tracking_bonus = RewTerm(
    #     func=mdp.position_command_error_bonus,
    #     weight=2.5,
    #     params={"asset_cfg": SceneEntityCfg("robot", body_names="link_eef"), "command_name": "ee_pose"},
    # )
    end_effector_position_tracking_fine_grained = RewTerm(
        ...
        weight=0.1,
        params={"asset_cfg": SceneEntityCfg("robot", body_names="link_eef"), "std": 0.1, "command_name": "ee_pose"},
    )
...
class CurriculumCfg:
    ...
    joint_vel = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "joint_vel", "weight": -0.002, "num_steps": 4500}
    )
